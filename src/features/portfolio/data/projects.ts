...
export const projects: Project[] = [
  {
    num: "01",
    title: "XLSmart Corporate",
    description:
      "XLSMART is a corporate website for PT XLSMART Telecom Sejahtera Tbk, a telecommunications group in Indonesia that owns brands like XL, XL SATU, Smartfren, AXIS, and XL Prioritas",
    stack: ["React.js", "Next.js", "Flowbite", "TailwindCSS"],
    image: "/images/projects/XLSmart.webp",
    liveUrl: "https://www.xlsmart.co.id/",
    githubUrl: "",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    title: "Axis Store",
    description:
      "Axis Store is a web application that allows users to purchase Axis SIM or ESIM cards online, select their desired mobile numbers, and choose from various data packages",
    stack: ["React.js", "Next.js", "Bootstrap"],
    image: "/images/projects/AxisStore.webp",
    liveUrl: "https://store.axis.co.id/",
    githubUrl: "",
  },
  {
    num: "05",
